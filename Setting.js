...
global.owner = process.env.OWNER_NUMBER  || '254112851562' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '',15_07_2024_SIGMA_MD_N3UCNsPJ_MAHER_ZUBAIR ''// PUT YOUR SESSION ID
